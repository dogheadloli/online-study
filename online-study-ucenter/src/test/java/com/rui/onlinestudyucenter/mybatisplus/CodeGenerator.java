package com.rui.onlinestudyucenter.mybatisplus;
...
public class CodeGenerator {
    ...
    public void genCode() {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/online_study_" + moduleName + "?serverTimezone=GMT%2B8");
        ...
        strategy.entityTableFieldAnnotationEnable(false);// 不生成注释
